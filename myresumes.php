<?php
   ...
   $fn->authPage();
   $resumes=$database->query('SELECT * FROM resumes WHERE user_id = '.$fn->auth()['id'].' ORDER BY id DESC' );
            ...
            <div class="col-12 col-md-6 p-2">
                <div class="p-2 border rounded">
                    ...
                    <div class="d-flex gap-2 mt-1">
                        <a href="viewresume.php?resume=<?= urlencode($resume['slug']) ?>" class="text-decoration-none small">
                            <i class="bi bi-file-text"></i> Open
                        </a>
                        <a href="updateresume.php?resume=<?= urlencode($resume['slug']) ?>" class="text-decoration-none small">
