...
if ($_POST) {
    ...
    $requiredFields = ['resume_id', 'position', 'company', 'started', 'ended', 'job_desc'];
    ...
    try {
        ...
        $stmt = $database->connect()->prepare("INSERT INTO experience ($columns, resume_id) VALUES ($placeholders, ?)");
